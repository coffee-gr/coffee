...
class D43_CNG(SBP):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.r1 = -(2177.*math.sqrt(295369.) - 1166427.)/(25488.)
        self.r2 = (66195.*math.sqrt(53.*5573.) - 35909375.)/101952.
        self.A = be.array([-1./12., 2./3., 0., -2./3., 1./12.])
        self.name = "D43_CNG"
...
class D65_min_err(SBP):
    ...
    def __init__(self, *args, **kwargs):
        self.name = "D65"
        self.A = be.array([1./60.,-3./20.,3./4.,0.,-3./4.,3./20.,-1./60.])
...
class D43_2_CNG(SBP):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.r1 = -(2177.*math.sqrt(295369.) - 1166427.)/(25488.)
        self.r2 = (66195.*math.sqrt(53.*5573.) - 35909375.)/101952.
        self.A = be.array([-1./12.,16./12.,-30./12.,16./12.,-1./12.])
        self.name = "D43_2_CNG"
