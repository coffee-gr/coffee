...
if __name__=='__main__':
    ...
    """This program outputs the keys and contents of the first two levels of an hdf file. If the file is produced from simulation_data.py then the "Numerical Error" and "System Data" groups 
